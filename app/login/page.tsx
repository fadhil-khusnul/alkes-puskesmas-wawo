      ...
      <div className="bg-white p-8 rounded-xl shadow-sm border border-slate-200 max-w-sm w-full">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <button 
            type="submit" 
            disabled={loading}
            className="w-full bg-teal-500 hover:bg-teal-600 text-white px-4 py-2.5 rounded-md font-medium text-sm transition-colors shadow-sm shadow-teal-200 disabled:opacity-70 mt-2 flex items-center justify-center gap-2"
          >
            {loading && (
